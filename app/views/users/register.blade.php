...
<!-- add your css and js here, dont add the jquery library again -->
 ...
 <link rel="stylesheet" href="{{ asset('assets/styles/css/register.css')}} ">

 <!-- <link href='../../../public/assets/styles/css/demo.css' rel='stylesheet' /> -->
 <link rel="stylesheet" href="{{ asset('assets/styles/css/demo.css') }}">

<!-- Contact Form CSS files -->
<!-- <link href='../../../public/assets/styles/css/basic.css' rel='stylesheet' /> -->
<link rel="stylesheet" href="{{ asset('assets/styles/css/basic.css') }}">
